...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center">
      ...
      <div className="relative mx-4 my-8 flex w-[95%] flex-col items-center justify-start overflow-hidden rounded-3xl bg-[#17332D] bg-gradient-to-b py-16  ">
        ...
        <div className="z-10 text-white">
          <h2 className=" mx-auto mb-2 -skew-x-2 text-center text-4xl font-bold">
            ...
            <span className="relative inline-block">
              American Dream
              <svg
                className="absolute -bottom-2 right-0 w-[250px] rotate-180 scale-90"
          ...
          <div className="mb-8 flex flex-col items-center justify-center gap-1 space-x-0 space-y-16 pt-8 lg:flex-row lg:space-y-0 lg:pt-20">
            ...
            <svg
              ...
              viewBox="0 0 59 24"
              fill="none"
              className="rotate-90 scale-[.8] lg:rotate-0"
            >
              <path
            ...
            <div className="relative flex w-[400px] flex-col items-center rounded-2xl  bg-gradient-to-t from-transparent via-primary/20 to-primary/80 text-center xl:w-[400px]">
              {/* <Image
                ...
                decoding="async"
                data-nimg="1"
                className="h-[120px] w-[80px] lg:h-[140px] lg:w-[100px]"
