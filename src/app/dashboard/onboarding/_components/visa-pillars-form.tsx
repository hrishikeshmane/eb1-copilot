...
const VisaPillarForm = ({ form }: SubFormProps) => {
  ...
  return (
    <div className="mx-1 grid grid-cols-1 gap-0 text-sm">
      <ScrollToTop />
      <Alert className="mb-4 border-primary/50">
        <Info className="h-4 w-4" />
        <AlertTitle className="">Heads up!</AlertTitle>
        <AlertDescription>
          Take your time answering the questionnaire. These question will help
          us understand your profile and help draft a plan for you.
          <br />
          You can also add/update your evidence later once you have submited the
          form.
        </AlertDescription>
      </Alert>

      {/* Critical Role */}
      <VisaPillarSection title="Critical Role" required={true}>
        <>
          <div className="mb-4 flex flex-col gap-3 text-sm">
            <div className="space-y-2 font-semibold">
              <p>
                Please describe what you do at work, and in your past
                workplaces, in detail. Tell us the story of your career.
              </p>
              <p>
              ...
              <p>
                ...
                impact on your organization or company? Please explain in
                detail.
              </p>
              <p>
                Is there any press or documentation that speaks to some
                technical or commercial success of a product or service of your
                company? Also mention if that makes a mention of you.
              </p>
            </div>
          </div>
      ...
      {/* High Remuneration */}
      <VisaPillarSection title="High Remuneration" required={true}>
        <>
          <div className="mb-4 flex flex-col gap-3 text-sm">
            <div className="space-y-2 font-semibold">
              <p>
                What is your annual remuneration? Please detail out all aspects
                of it, i.e., was it a contract or a full-time role? Outline the
      ...
      <VisaPillarSection title="Awards for Excellence">
        <>
          <div className="mb-4 flex flex-col gap-3 text-sm">
            <p>
              List all the awards you have won so far, and what you have to
              prove them (certificates, press coverage, etc.). Include every
              award you have won since college/undergrad, and what those awards
              are for. Also, describe more about each of the awards, which
              organization gave them, and talk about how many other people have
              competed and won them. Also, talk about the caliber and profile of
              the other people who won those awards.
            </p>
            ...
            <div className="space-y-2 font-semibold">
              <p>
                Any scholarships, fellowships, or competitive assistantships
                that you ever got?
              </p>
              <p>
              ...
              <p>
                Any best paper award in any conference or event? Any patents
                that got awarded to you? Do you have any patent review documents
                and application documents to prove it?
              </p>
              <p>
      ...
      <VisaPillarSection title="Original Contribution">
        <>
          <div className="mb-4 flex flex-col gap-3 text-sm">
            <div className="space-y-2 font-semibold">
              <p>
              ...
              <p>
                ...
                workplace, but an entire field (even outside that organization
                or company)? Be creative and think hard of anything.
              </p>
              <p>
                Do you have patents? What is the application of this patent, and
                how is it significant? What value does it fetch the overall
                field, or the business? Do you have evidence of other people who
                are already using it?
              </p>
              <p>
                Do you have any non-patented inventions? Same follow up
                questions as above, and what evidence do you think is necessary
                to show that the inventions are your own?
              </p>
              <p>
              ...
              <p>
                If you have a thesis document, do you know the impact your
                thesis had in your space? Do you have people (experts) that can
                provide you with supporting letters that strongly argue that
                your research work was impactful?
              </p>
              <p>
                Anything else big or small you can think of that can be used to
                argue that you did something that was impactful to a lot of
                people and/or the entire field?
              </p>
            </div>
          </div>
          <div className="col-span-1">
      ...
      {/* Original Authorship */}
      <VisaPillarSection title="Original Authorship">
        <>
          <div className="mb-4 flex flex-col gap-3 text-sm">
            <div className="space-y-2 font-semibold">
              <p>
                Have you published any articles in Scholarly journals? In what
                journals? Dig up the citation count, details about how “major”
                the journal is, and all other details.
              </p>
              <p>
              ...
              <p>
                Have you published any articles anywhere else? White papers,
                blog posts, internal company publications, etc. Anything else at
                all that is useful for other learned people in your field?
      ...
      <VisaPillarSection title="Judging the work of Peers">
        <>
          <div className="mb-4 flex flex-col gap-3 text-sm">
            <div className="space-y-2 font-semibold">
              <p>
                Have you ever reviewed any literature as a peer before the
                publication of it in a journal or conference? Please explain
                them in detail.
              </p>
              <p>
              ...
              <p>
                Were you in a position where you had to do a review of a peer’s
                or multiple peers’ work at your workplace (code reviews, design
              ...
              render={({ field }) => (
                <FormItem className="flex h-full flex-col justify-between">
                  <FormLabel>
                    ...
                    professional publication, proceedings of a conference, or
                    the like?
                  </FormLabel>
                  <FormControl>
                    <RadioGroup
      ...
      {/* Media Coverage */}
      <VisaPillarSection title="Media Coverage">
        <>
          <div className="mb-4 flex flex-col gap-3 text-sm">
            <div className="space-y-2 font-semibold">
              <p>
              ...
              <p>
                Have you been featured in any news, TV shows, podcasts,
                broadcasts etc.? Please explain in detail.
              </p>
              <p>
                Was there any instance and/or evidence of other people talking
                and praising your work? Please explain in detail.
              </p>
              <p>
                Is there press coverage about any particular product that you
                are working on or have worked on? Please explain in detail.
                Also, note if there is any mention of you on the press item?
              </p>
            </div>
          </div>
          <div className="col-span-1">
      ...
      <VisaPillarSection title="Memberships in Elite Associations">
        <>
          <div className="mb-4 flex flex-col gap-3 text-sm">
            <div className="space-y-2 font-semibold">
              <p>
              ...
              <p>
                ...
                super restricted to extremely qualified people, but you have
                risen the ranks to the board of the association, and are playing
                an important role?
              </p>
            </div>
          </div>
      ...
      <VisaPillarSection title="Exhibitions and Showcases">
        <>
          <div className="mb-4 flex flex-col gap-3 text-sm">
            <div className="space-y-2 font-semibold">
              <p>
      ...
      {/* Commercial Success */}
      <VisaPillarSection title="Commercial Success">
        <div className="mb-4 flex flex-col gap-3 text-sm">
          <div className="space-y-2 font-semibold">
            <p>
      ...
      {/* Miscellaneous */}
      <VisaPillarSection title="Miscellaneous">
        <>
          <div className="col-span-1">
            <FormField
              control={form.control}
              ...
              render={({ field }) => (
                <FormItem className="flex h-full flex-col justify-between">
                  <FormLabel>
                    ...
                    public service announcements (Letters from the
                    organizations, press, internet, etc.)? What was your title,
              ...
              render={({ field }) => (
                <FormItem className="flex h-full flex-col justify-between">
                  <FormLabel>
                    ...
                    able to talk about you, and preferably link their LinkedIn
                    URL
                  </FormLabel>
                  <FormControl>
                    <RadioGroup
              ...
              render={({ field }) => (
                <FormItem className="flex h-full flex-col justify-between">
                  <FormLabel>
                    ...
                    with prevailing issues of popular attention currently, such
                    as global warming, housing, data privacy, cybersecurity,
