...
export const Thread: FC = () => {
  return (
    <TooltipProvider>
      <ThreadPrimitive.Root className="dark flex h-full flex-col items-stretch px-4 text-foreground">
...
const AssistantMessage: FC = () => {
  return (
    <MessagePrimitive.Root className="relative mx-auto flex w-full max-w-screen-md gap-3">
      ...
      <BotAvatar className="flex size-8 flex-shrink-0 items-center justify-center rounded-[24px] border border-white/15 shadow" />
...
const BotAvatar = ({ className }: { className?: string }) => {
  return (
    <div
      className={cn(
        "flex h-14 w-14 items-center justify-center rounded-full bg-muted p-1",
        className,
      )}
    >
      <Bot />
